...
| **04** | Filter Assignment List | When selecting a "Sort by" Filter the list will rearrange assignments in proper order | Sort by Class | Assignments will be sorted by Class Name | Assignmets are sorted by class name |✅| Success | <img width="877" height="773" alt="image" src="https://github.com/user-attachments/assets/2326dbff-6edb-4a83-8202-273189109364" /> |
| **05** |  |  | |  |  |(✅/❌)|  |  |
