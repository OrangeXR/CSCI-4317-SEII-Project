...
# ===============
sample_users = [
    ("demo",   "demo", "scrypt:32768:8:1$IT3KjqtMgxIUZB1S$0cc425013292eac69df26608de00c8b9f028162d6b56ba08a16ec75e5277a3319b7d1f431f9a103527fb618bf92fc0f58f12dc51186833295cfd9284bdf99cfa",  "user_1.png"),
...
#   (id,        user_id,      "name",              "class_name",             "category",   "due_date",        "status")
    (  1,       demo_id,       'Assignment 01',     'Software Engineering',    'Essay',      '2026-04-27',           0, '', ''),
    (  2,       demo_id,       'Assignment 02',     'Data Structures',         'Essay',      '2026-04-28',           0, '', ''),
    (  3,       demo_id,       'Assignment 03',     'Algorithms',              'Essay',      '2026-04-29',           0, '', ''),
    (  4,       demo_id,       'Assignment 04',     'Software Engineering',    'Essay',      '2026-04-30',           0, '', ''),
    (  5,       demo_id,       'Assignment 05',     'Data Structures',         'Essay',      '2026-05-01',           0, '', ''),
    (  6,       demo_id,       'Assignment 06',     'Algorithms',              'Essay',      '2026-05-02',           0, '', ''),
    (  7,       demo_id,       'Assignment 07',     'Software Engineering',    'Essay',      '2026-05-03',           0, '', ''),
    (  8,       demo_id,       'Assignment 08',     'Data Structures',         'Essay',      '2026-05-04',           0, '', ''),
    (  9,       demo_id,       'Assignment 09',     'Algorithms',              'Essay',      '2026-05-05',           0, '', ''),
    ( 10,       demo_id,       'Assignment 10',     'Software Engineering',    'Essay',      '2026-05-06',           0, 'Read Where the Red Fern Grows', ''),
    ( 11,       demo_id,       'Assignment 11',     'Data Structures',         'Essay',      '2026-05-07',           0, 'Read The Red Badge of Courage', ''),
    ( 12,       demo_id,       'Assignment 12',     'Algorithms',              'Essay',      '2026-05-08',           0, '', ''),
    ( 13,       demo_id,       'Assignment 13',     'Software Engineering',    'Essay',      '2026-05-09',           0, '', ''),
    ( 14,       demo_id,       'Assignment 14',     'Data Structures',         'Essay',      '2026-05-10',           0, '', ''),
    ( 15,       demo_id,       'Assignment 15',     'Algorithms',              'Essay',      '2026-05-11',           0, '', ''),
    ( 16,       demo_id,       'Assignment 16',     'Software Engineering',    'Essay',      '2026-05-12',           0, '', ''),
    ( 17,       demo_id,       'Assignment 17',     'Data Structures',         'Essay',      '2026-05-13',           0, '', ''),
    ( 18,       demo_id,       'Assignment 18',     'Algorithms',              'Essay',      '2026-05-14',           0, '', ''),
    ( 19,       demo_id,       'Assignment 19',     'Software Engineering',    'Essay',      '2026-05-15',           0, '', ''),
    ( 20,       demo_id,       'Assignment 20',     'Data Structures',         'Essay',      '2026-05-16',           0, '', ''),
    ( 21,       demo_id,       'Assignment 21',     'Algorithms',              'Essay',      '2026-05-17',           0, '', ''),
    ( 22,       demo_id,       'Assignment 22',     'Software Engineering',    'Essay',      '2026-05-18',           0, '', ''),
    ( 23,       demo_id,       'Assignment 23',     'Data Structures',         'Essay',      '2026-05-19',           0, '', ''),
    ( 24,       demo_id,       'Assignment 24',     'Algorithms',              'Essay',      '2026-05-20',           0, '', ''),
    ( 25,       demo_id,       'Assignment 25',     'Software Engineering',    'Essay',      '2026-05-21',           0, '', ''),
    ( 26,       demo_id,       'Assignment 26',     'Data Structures',         'Essay',      '2026-05-22',           0, '', ''),
    ( 27,       demo_id,       'Assignment 27',     'Algorithms',              'Essay',      '2026-04-26',           0, '', ''),
    ( 28,       demo_id,       'Assignment 28',     'Software Engineering',    'Essay',      '2026-04-25',           0, '', ''),
...
cursor.executemany("""
INSERT INTO assignments (id, user_id, name, class_name, category, due_date, status, notes, file_path)
VALUES (?,?,?,?,?,?,?,?,?)
""", sample_assignments)
